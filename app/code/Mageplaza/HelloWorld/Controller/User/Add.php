...
namespace Mageplaza\HelloWorld\Controller\User;

use Magento\Framework\App\Action\Action;
use Magento\Framework\App\Action\Context;
use Magento\Framework\App\ResponseInterface;
use Mageplaza\HelloWorld\Model\Post as User;
use Mageplaza\HelloWorld\Model\ResourceModel\Post as UserResource;
...
class Add extends Action
{
    ...
    public function execute()
    {
        ...
        $redirect->setPath('mageplaza_helloworld/user/view');
        return $redirect;
    }
}