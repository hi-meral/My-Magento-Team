...
namespace Espl\UserModel\Controller\User;

use Magento\Framework\App\Action\Action;
use Magento\Framework\App\Action\Context;
use Magento\Framework\App\ResponseInterface;
use Espl\UserModel\Model\User;
use Espl\UserModel\Model\ResourceModel\User as UserResource;
...
class Add extends Action
{
    ...
    public function execute()
    {
        ...
        $redirect->setPath('usermodel/user/view');
        return $redirect;
    }
}