...
namespace Espl\Blog\Controller\User;

use Magento\Framework\App\Action\Action;
use Magento\Framework\App\Action\Context;
use Magento\Framework\App\ResponseInterface;
use Espl\Blog\Model\Post as User;
use Espl\Blog\Model\ResourceModel\Post as UserResource;
...
class Add extends Action
{
    ...
    public function execute()
    {
        ...
        $redirect->setPath('espl_blog/user/view');
        return $redirect;
    }
}